...
-- ═══════════════════════════════════════════════════════════════════════════
-- ENUMS  (DO $$ blocks make them idempotent)
-- ═══════════════════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS tgdp_balances (
  uid                 TEXT            PRIMARY KEY REFERENCES users(uid) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS tgdp_transactions (
...
CREATE TABLE IF NOT EXISTS tgdp_withdrawals (
...
CREATE TABLE IF NOT EXISTS ftr_balances (
  uid                 TEXT            NOT NULL REFERENCES users(uid) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS ftr_swaps (
...
CREATE TABLE IF NOT EXISTS ftr_redemptions (
...
CREATE TABLE IF NOT EXISTS gic_balances (
  uid                 TEXT            PRIMARY KEY REFERENCES users(uid) ON DELETE CASCADE,
  balance             NUMERIC(20,8)   NOT NULL DEFAULT 0 CHECK (balance >= 0),
  updated_at          TIMESTAMPTZ     NOT NULL DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS gic_credits (
...
CREATE TABLE IF NOT EXISTS gic_redemptions (
  redeem_id               TEXT            PRIMARY KEY,
  licensee_id             TEXT            NOT NULL REFERENCES users(uid),
...
CREATE TABLE IF NOT EXISTS tjr_returns (
...
CREATE TABLE IF NOT EXISTS tjdb_designs (
...
CREATE TABLE IF NOT EXISTS tjdb_orders (
...
CREATE INDEX IF NOT EXISTS idx_kyc_status          ON kyc(kyc_status);
CREATE INDEX IF NOT EXISTS idx_earmarks_user       ON earmarks(user_id);
CREATE INDEX IF NOT EXISTS idx_earmarks_status     ON earmarks(status);
CREATE INDEX IF NOT EXISTS idx_tgdp_tx_from        ON tgdp_transactions(from_user_id);
CREATE INDEX IF NOT EXISTS idx_tgdp_tx_to          ON tgdp_transactions(to_user_id);
CREATE INDEX IF NOT EXISTS idx_tgdp_tx_type        ON tgdp_transactions(type);
CREATE INDEX IF NOT EXISTS idx_tgdp_tx_created     ON tgdp_transactions(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_ftr_swaps_user      ON ftr_swaps(user_id);
CREATE INDEX IF NOT EXISTS idx_ftr_swaps_expiry    ON ftr_swaps(expiry_date);
CREATE INDEX IF NOT EXISTS idx_gic_credits_lic     ON gic_credits(licensee_id);
CREATE INDEX IF NOT EXISTS idx_gic_credits_stream  ON gic_credits(stream);
CREATE INDEX IF NOT EXISTS idx_complaints_status   ON complaints(status);
CREATE INDEX IF NOT EXISTS idx_complaints_cmp      ON complaints(complainant_id);
CREATE INDEX IF NOT EXISTS idx_complaints_ombuds   ON complaints(assigned_ombudsman);
CREATE INDEX IF NOT EXISTS idx_designs_designer    ON tjdb_designs(designer_id);
CREATE INDEX IF NOT EXISTS idx_designs_status      ON tjdb_designs(status);
CREATE INDEX IF NOT EXISTS idx_orders_buyer        ON tjdb_orders(buyer_id);
CREATE INDEX IF NOT EXISTS idx_orders_design       ON tjdb_orders(design_id);
CREATE INDEX IF NOT EXISTS idx_audit_action        ON audit_logs(action);
CREATE INDEX IF NOT EXISTS idx_audit_actor         ON audit_logs(actor_id);
CREATE INDEX IF NOT EXISTS idx_audit_created       ON audit_logs(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_hhlinks_licensee    ON household_links(licensee_id);
